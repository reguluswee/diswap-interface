...
// import DogeBackgroundImage from '../assets/images/oribackground.png';
...
const BodyWrapper = styled.div`
  ...
  background: url(${({ theme }) => theme.bg15} ) center 100% / 90% no-repeat;
...
//   return (
//     <FooterWrapper>
//         <FooterNavLink href="https://twitter.com/OriSwap_fans" target="_blank">Twitter</FooterNavLink>
//         <FooterNavLink href="https://medium.com/@OriSwap_fans" target="_blank">Medium</FooterNavLink>
//         <FooterNavLink href="https://t.me/OriSwap_en" target="_blank">Telegram</FooterNavLink>
          ...
          <BodyWrapper>
            ...
            <Web3ReactManager>
              <Switch>
                ...
                <Route exact path="/nftfarm/:type/:pid/:pairOrTokenAddress/:wnftAddress/:mussesId" component={NftFarm} />
